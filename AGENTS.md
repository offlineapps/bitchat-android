# Bluewhale Android - Agent Guide

This document provides context, architectural insights, and development standards for AI agents working on the Bluewhale Android codebase.

## 1. Project Overview
**Bluewhale** is a decentralized, off-grid communication application focused on privacy and censorship resistance. It utilizes mesh networking (primarily Bluetooth LE and Tor/Arti) to enable peer-to-peer messaging without centralized servers.
...
**Root Package:** `com.bluewhale.android`
