...
class SecurityManagerTest {
    ...
    fun `validatePacket - handles ANNOUNCE duplicates correctly`() {
        ...
        val packet1 = BluewhalePacket(
            type = MessageType.ANNOUNCE.value,
            ttl = com.bluewhale.android.util.AppConstants.MESSAGE_TTL_HOPS, // 7u
            senderID = unknownPeerID,
            payload = payload
        )
        ...
        val packet2 = packet1.copy(ttl = (com.bluewhale.android.util.AppConstants.MESSAGE_TTL_HOPS - 1u).toUByte())
        ...
        val packet3 = packet1.copy(ttl = com.bluewhale.android.util.AppConstants.MESSAGE_TTL_HOPS)
