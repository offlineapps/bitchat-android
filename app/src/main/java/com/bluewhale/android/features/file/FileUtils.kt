package com.bluewhale.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.bluewhale.android.model.BluewhaleFilePacket
    ): String {
    ...
    /**
     * Classify BluewhaleMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.bluewhale.android.model.BluewhaleMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.bluewhale.android.model.BluewhaleMessageType.Image
            lower.startsWith("audio/") -> com.bluewhale.android.model.BluewhaleMessageType.Audio
            else -> com.bluewhale.android.model.BluewhaleMessageType.File
        }
    }
