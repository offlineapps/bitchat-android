...
@Parcelize
enum class BluewhaleMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * BluewhaleMessage - 100% compatible with iOS version
 */
@Parcelize
data class BluewhaleMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: BluewhaleMessageType = BluewhaleMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): BluewhaleMessage? {
            try {
                ...
                return BluewhaleMessage(
                    id = id,
                    sender = sender,
                    content = content,
                    type = BluewhaleMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,
