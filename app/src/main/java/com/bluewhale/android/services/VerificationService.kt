...
object VerificationService {
    private const val CONTEXT = "bluewhale-verify-v1"
    private const val RESPONSE_CONTEXT = "bluewhale-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "bluewhale" || uri.host != "verify") return null
