...
//
//    suspend fun saveMessage(message: BluewhaleMessage, forChannel: String) = withContext(Dispatchers.IO) {
...
//    }
//
//    suspend fun loadMessagesForChannel(channel: String): List<BluewhaleMessage> = withContext(Dispatchers.IO) {
...
//    }
//
//    private fun loadMessagesFromFile(file: File): List<BluewhaleMessage> {
//        if (!file.exists()) {
//            return emptyList()
//        }
//
...
//                    ois.readObject() as List<BluewhaleMessage>
//                }
//            }
//        } catch (e: Exception) {
...
//    }
//
//    private fun saveMessagesToFile(file: File, messages: List<BluewhaleMessage>) {
