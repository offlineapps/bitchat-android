 ...
 * 
 * This class handles all relay decisions and logic for bluewhale packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.bluewhale.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: BluewhalePacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: BluewhalePacket, fromPeerID: String): Boolean {
