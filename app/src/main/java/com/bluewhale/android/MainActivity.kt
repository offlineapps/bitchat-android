...
import com.bluewhale.android.onboarding.BluetoothCheckScreen
import com.bluewhale.android.onboarding.BluetoothStatus
import com.bluewhale.android.onboarding.BluetoothStatusManager
import com.bluewhale.android.onboarding.BatteryOptimizationManager
import com.bluewhale.android.onboarding.BatteryOptimizationPreferenceManager
import com.bluewhale.android.onboarding.BatteryOptimizationScreen
import com.bluewhale.android.onboarding.BatteryOptimizationStatus
import com.bluewhale.android.onboarding.BackgroundLocationPermissionScreen
import com.bluewhale.android.onboarding.InitializationErrorScreen
import com.bluewhale.android.onboarding.InitializingScreen
import com.bluewhale.android.onboarding.LocationCheckScreen
import com.bluewhale.android.onboarding.LocationStatus
import com.bluewhale.android.onboarding.LocationStatusManager
import com.bluewhale.android.onboarding.OnboardingCoordinator
import com.bluewhale.android.onboarding.OnboardingState
import com.bluewhale.android.onboarding.PermissionExplanationScreen
import com.bluewhale.android.onboarding.PermissionManager
import com.bluewhale.android.ui.ChatScreen
import com.bluewhale.android.ui.ChatViewModel
import com.bluewhale.android.ui.OrientationAwareActivity
import com.bluewhale.android.ui.theme.BluewhaleTheme
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.bluewhale.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.bluewhale.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.bluewhale.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.bluewhale.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        try { com.bluewhale.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.bluewhale.android.service.MeshServiceHolder.getOrCreate(applicationContext)
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.bluewhale.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.bluewhale.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.bluewhale.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.bluewhale.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.bluewhale.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.bluewhale.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.bluewhale.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.bluewhale.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.bluewhale.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.bluewhale.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.bluewhale.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.bluewhale.android.geohash.GeohashChannelLevel.REGION
                        else -> com.bluewhale.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.bluewhale.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.bluewhale.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "bluewhale" || uri.host != "verify") return
