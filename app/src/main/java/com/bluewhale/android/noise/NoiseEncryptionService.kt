...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.bluewhale.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.bluewhale.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.bluewhale.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a BluewhalePacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.bluewhale.android.protocol.BluewhalePacket): com.bluewhale.android.protocol.BluewhalePacket? {
    ...
    /**
     * Verify a BluewhalePacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.bluewhale.android.protocol.BluewhalePacket, publicKey: ByteArray): Boolean {
