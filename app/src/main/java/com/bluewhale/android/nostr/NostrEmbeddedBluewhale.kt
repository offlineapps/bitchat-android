...
/**
 * Bluewhale-over-Nostr Adapter
 * Direct port from iOS implementation for 100% compatibility
 */
object NostrEmbeddedBluewhale {
    
    private const val TAG = "NostrEmbeddedBluewhale"
    
    /**
     * Build a `bluewhale1:` base64url-encoded Bluewhale packet carrying a private message for Nostr DMs.
     */
    fun encodePMForNostr(
        ...
        try {
            ...
            return "bluewhale1:" + base64URLEncode(data)
        } catch (e: Exception) {
    ...
    /**
     * Build a `bluewhale1:` base64url-encoded Bluewhale packet carrying a delivery/read ack for Nostr DMs.
     */
    ...
    /**
     * Build a `bluewhale1:` ACK (delivered/read) without an embedded recipient peer ID (geohash DMs).
     */
    ...
    /**
     * Build a `bluewhale1:` payload without an embedded recipient peer ID (used for geohash DMs).
     */
