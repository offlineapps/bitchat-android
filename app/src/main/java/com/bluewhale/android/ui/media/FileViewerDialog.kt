...
import com.bluewhale.android.features.file.FileUtils
 ...
 */
private fun tryOpenFile(context: Context, packet: BluewhaleFilePacket) {
    try {
        // First try to save to temp file and open
        val tempFile = File.createTempFile("bluewhale_", ".${packet.fileName.substringAfterLast(".")}", context.cacheDir)
